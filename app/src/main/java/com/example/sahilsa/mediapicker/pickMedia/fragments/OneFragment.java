...
public class OneFragment extends Fragment {
    ...
    public static OneFragment newInstance(GalleryActivity.FirstPageFragmentListener firstPageFragmentListener) {
        OneFragment subCategoriesFragment = new OneFragment();
