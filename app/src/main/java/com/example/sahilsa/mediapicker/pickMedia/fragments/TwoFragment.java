...
import com.example.sahilsa.mediapicker.pickMedia.adapters.BucketsAdapter;
...
public class TwoFragment extends Fragment {
    ...
    static GalleryActivity.FirstPageFragmentListener firstPageFragmentListener1;

    public static TwoFragment newInstance() {
        TwoFragment subCategoriesFragment = new TwoFragment();
        return subCategoriesFragment;
    }

    public static TwoFragment newInstance(GalleryActivity.FirstPageFragmentListener firstPageFragmentListener) {
        TwoFragment subCategoriesFragment = new TwoFragment();
        firstPageFragmentListener1 = firstPageFragmentListener;
        return subCategoriesFragment;
    }
...
//                startActivity(intent);
                firstPageFragmentListener1.onSwitchToNextFragment();
            }
